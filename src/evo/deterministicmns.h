...
#ifndef HU_EVO_DETERMINISTICMNS_H
#define HU_EVO_DETERMINISTICMNS_H
...
public:
    ...
    CDeterministicMNCPtr GetMNByOperatorKey(const CPubKey& pubKey);  // PIVHU: ECDSA
...
#endif // HU_EVO_DETERMINISTICMNS_H
