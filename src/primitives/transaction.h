...
#ifndef HU_PRIMITIVES_TRANSACTION_H
#define HU_PRIMITIVES_TRANSACTION_H
...
public:
    ...
    enum TxType: int16_t {
        ...
        // 5 reserved
        KHU_MINT = 6,        // HU → KHU_T (1:1 collateral)
        KHU_REDEEM = 7,      // KHU_T → HU (1:1 redemption)
        KHU_LOCK = 8,        // KHU_T → ZKHU (K-pool locking)
        KHU_UNLOCK = 9,      // ZKHU → KHU_T + yield (maturity 4320 blocks)
        KHU_DOMC_COMMIT = 10, // DOMC commit vote
        KHU_DOMC_REVEAL = 11, // DOMC reveal vote
    };
...
#endif // HU_PRIMITIVES_TRANSACTION_H
