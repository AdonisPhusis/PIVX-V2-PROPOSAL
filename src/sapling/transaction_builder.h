...
#ifndef HU_SAPLING_TRANSACTION_BUILDER_H
#define HU_SAPLING_TRANSACTION_BUILDER_H
...
public:
    ...
    // Set transaction type (e.g., for KHU_LOCK, KHU_UNLOCK)
    // MUST be called before Build() for special transaction types
    void SetType(CTransaction::TxType _type);

    // Set extra payload (for special transaction types like KHU_UNLOCK)
...
#endif // HU_SAPLING_TRANSACTION_BUILDER_H
