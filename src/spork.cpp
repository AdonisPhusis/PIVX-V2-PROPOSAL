...
/**
 * HU Spork Definitions
 * Default value 4070908800 = spork OFF (far future timestamp)
 */
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT,  4070908800ULL),
    MAKE_SPORK_DEF(SPORK_20_SAPLING_MAINTENANCE,            4070908800ULL),
    MAKE_SPORK_DEF(SPORK_23_HU_FINALITY_ENFORCEMENT,        4070908800ULL),
};
...
// Load spork values from previous session if they exist in sporkDB
