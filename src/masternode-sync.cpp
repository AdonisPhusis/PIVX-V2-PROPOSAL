...
int CMasternodeSync::GetNextAsset(int currentAsset)
{
    ...
    case (MASTERNODE_SYNC_SPORKS):
        return deterministicMNManager->LegacyMNObsolete() ? MASTERNODE_SYNC_FINISHED : MASTERNODE_SYNC_LIST;
    case (MASTERNODE_SYNC_LIST):
        return deterministicMNManager->LegacyMNObsolete() ? MASTERNODE_SYNC_FINISHED : MASTERNODE_SYNC_MNW;
...
bool CMasternodeSync::SyncWithNode(CNode* pnode)
{
    ...
    // DMN-only: skip legacy MN list/winner sync phases
