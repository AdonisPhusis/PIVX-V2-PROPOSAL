...
#ifndef HU_MASTERNODE_PAYMENTS_H
#define HU_MASTERNODE_PAYMENTS_H
 ...
 * HU: No budget system - just validates masternode payments.
 */
...
public:
    ...
    // HU: Legacy MN payment path (disabled - DMN only)
    ...
    std::string GetRequiredPaymentsString(int nBlockHeight);
    void FillBlockPayee(CMutableTransaction& txCoinbase, const CBlockIndex* pindexPrev) const;
...
#endif // HU_MASTERNODE_PAYMENTS_H
